...
// 17q pathfinder chip. For MQV dashboard to be able to plot the chip as it
// really looks include position in the site.
const WMI_QDMI_Site DEVICE_SITES[] = {
    &(WMI_QDMI_Site_impl_t){0, 0.0, 0.48618057383522},
    &(WMI_QDMI_Site_impl_t){1, 0.00929861849096706, 0.73387733614109},
    &(WMI_QDMI_Site_impl_t){2, 0.231402763018066, 0.0},
    &(WMI_QDMI_Site_impl_t){3, 0.240701381509033, 0.24769676230587},
    &(WMI_QDMI_Site_impl_t){4, 0.25, 0.49539352461174},
    &(WMI_QDMI_Site_impl_t){5, 0.259298618490967, 0.74309028691761},
    &(WMI_QDMI_Site_impl_t){6, 0.481402763018066, 0.00921295077652014},
    &(WMI_QDMI_Site_impl_t){7, 0.490701381509033, 0.25690971308239},
    &(WMI_QDMI_Site_impl_t){8, 0.5, 0.50460647538826},
    &(WMI_QDMI_Site_impl_t){9, 0.509298618490967, 0.75230323769413},
    &(WMI_QDMI_Site_impl_t){10, 0.518597236981934, 1.0},
    &(WMI_QDMI_Site_impl_t){11, 0.740701381509033, 0.26612266385891},
    &(WMI_QDMI_Site_impl_t){12, 0.75, 0.51381942616478},
    &(WMI_QDMI_Site_impl_t){13, 0.759298618490967, 0.76151618847065},
    &(WMI_QDMI_Site_impl_t){14, 0.768597236981934, 1.00921295077652},
    &(WMI_QDMI_Site_impl_t){15, 0.990701381509033, 0.27533561463543},
    &(WMI_QDMI_Site_impl_t){16, 1.0, 0.5230323769413}};
...
int WMI_QDMI_device_session_query_device_property(
  ...
  ADD_LIST_PROPERTY(QDMI_DEVICE_PROPERTY_SUPPORTEDPROGRAMFORMATS,
                    QDMI_Program_Format, SUPPORTED_PROGRAM_FORMATS,
