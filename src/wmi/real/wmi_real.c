...
const char *gate_set[] = {
    "__quantum__qis__id__body", "__quantum__qis__x__body",
    "__quantum__qis__y__body",  "__quantum__qis__sx__body",
...
static size_t parse_json(void *contents, size_t size, size_t nmemb,
...
int QDMI_control_submit(QDMI_Device dev, QDMI_Fragment *frag, int numshots,
  ...
  if (!is_power_of_two) {
    fprintf(stderr,
            "[Backend].............Powers of 2 required for number of shots, "
            "but is %i!\n",
            numshots);
